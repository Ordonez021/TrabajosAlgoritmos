...
class Tienda:
    ...
    #Vender una cierta cantidad del producto cuyo nombre es igual al
    #  recibido como parámetro. El método retorna el número de unidades 
    # efectivamente vendidas. Suponga que el nombre que se recibe como 
    # parámetro corresponde a uno de los productos de la tienda. 
    # Utilice el método vender de la clase Producto como parte de su solución.
    def venderProducto(self, pNombreProducto, pCantidad:int):
        Producto.Vender(pNombreProducto)
        Producto.__cantidadUnidadesVendidas += pCantidad
        return Producto.__cantidadUnidadesVendidas
    
    
    def cuantosPapeleria(self):
        Producto.Vender() == Tipo.PAPELERIA
        Tipo.PAPELERIA += 1
